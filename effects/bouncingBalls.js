...
class BauncingBalls {
    constructor(ballMode, mirrored, tail, BallCount, neopixelCount) {
    ...
    render() {
        ...
        for (let i = 0; i < this.ballCount; i++) {
            ...
            this.position[i] = Math.round(this.height[i] * (this.neopixelCount - 1) / this.startHeight);
        }
        ...
        for (let i = 0; i < this.ballCount; i++) {
            ...
            if (this.mirrored) {
                this.stripe = setPixel(this.neopixelCount - this.position[i], this.stripe, this.ballColors[i].r, this.ballColors[i].b, this.ballColors[i].g);
            }
        }
